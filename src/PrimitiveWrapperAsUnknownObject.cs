...
// Code from https://github.com/microsoft/Power-Fx/src/tests/Microsoft.PowerFx.Interpreter.Tests/Scenarios/PrimitiveWrapperAsUnknownObject.cs
    ...
    public class PrimitiveWrapperAsUnknownObject : IUntypedObject
    {
        ...
        public IUntypedObject this[int index]
        {
            get
            {
                ...
                Contract.Assert(index >= 0 && index <= a.Length);
        ...
        {
            Contract.Assert(Type == FormulaType.Boolean);
        ...
        public double GetDouble()
        {
            ...
            Contract.Assert(Type == FormulaType.Number);
        ...
        public decimal GetDecimal()
        {
            ...
            Contract.Assert(Type == FormulaType.Decimal);
        ...
        {
            Contract.Assert(Type == FormulaType.String);
        ...
        {
            Contract.Assert(Type == ExternalType.ObjectType);
